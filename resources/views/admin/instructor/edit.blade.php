                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control rounded-0 {{ $errors->has('firstname') ? 'is-invalid': '' }}" name="firstname"
                                    id="firstname" value="{{ old('firstname', $instructor->firstname) }}">
                                @error('firstname')
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control rounded-0" name="suffix" id="suffix"
                                    placeholder="(e.g) Jr. Sr." value="{{ old('suffix', $instructor->suffix) }}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control rounded-0 {{ $errors->has('contact_no') ? 'is-invalid' : '' }}" name="contact_no" id="contact"
                                    value="{{ old('contact_no', $instructor->contact_no) }}">
                                    @error('contact_no')
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select name="gender" class="form-control rounded-0 {{ $errors->has('gender') ? 'is-invalid' : '' }}" id="gender">
                                    <option value="male" {{ old('gender', Str::upper($instructor->gender)) == 'MALE' ? 'selected' : '' }}>Male</option>
                                    <option value="female" {{ old('gender', Str::upper($instructor->gender)) == 'FEMALE' ? 'selected' : '' }}>Female
                                    </option>
                                </select>
                                @error('gender')
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control rounded-0 {{ $errors->has('birthdate') ? 'is-invalid' : '' }}" value="{{ old('birthdate', $instructor->birthdate) }}"
                                    name="birthdate">
                                    @error('birthdate')
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select name="civil_status" class="form-control rounded-0 {{ $errors->has('civil_status') ? 'is-invalid' : '' }}" id="civil_status">
                                    <option value="single" {{ old('civil_status', $instructor->civil_status) == 'Single' ? 'selected' : '' }}>
                                        Single</option>
                                    <option value="married" {{ old('civil_status', $instructor->civil_status) == 'Married' ? 'selected' : '' }}>
                                        Married</option>
                                    <option value="widow" {{ old('civil_status' , $instructor->civil_status) == 'Widow' ? 'selected' : '' }}>Widow
                                    </option>
                                </select>
                                @error('civil_status')
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select name="work_status" class="form-control rounded-0 {{ $errors->has('work_status') ? 'is-invalid' : '' }}" id="work_status">
                                    <option value="full-time" {{ old('work_status', $instructor->status) == 'full-time' ? 'selected' : '' }}>Full
                                        time</option>
                                    <option value="part-time" {{ old('work_status', $instructor->status) == 'part-time' ? 'selected' : '' }}>Part
                                        time</option>
                                </select>
                                @error('work_status')
