<div class="text-center">
	<a href="{{ route('student.subject.create', [$student]) }}" class="btn btn-primary btn-sm text-center mr-3"><i class="fa fa-plus"></i></a>
	<a href="{{ route('student.grade.show', [$student]) }}" class="btn btn-primary btn-sm text-center mr-3"><i class="fa fa-eye"></i></a>
