<div class="text-center">
	...
	<button class="btn btn-info btn-sm btn-white text-center text-white" title="Print Grade" data-src="{{ $student }}" onclick="printGrade(this)" data-student-id="{{$student->id}}"><i class="fa fa-print" style="pointer-events: none;"></i></button>
</div>
