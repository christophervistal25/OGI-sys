...
<div class="card shadow mb-4 rounded-0">
	<div class="card-header py-3 rounded-0">
		<h6 class="m-0 font-weight-bold text-primary">List of all Deadlines</h6>
	</div>

	<div class="card-body">
		<a class="btn btn-primary btn-sm mb-2 text-center text-white  float-right font-weight-bold" href="{{ route('evaluation.create')  }}"><i class="fa fa-plus"></i> Add new deadline</a>
				...
				@foreach($evaluations as $evaluation)
					<tr>
						...
						<td class='text-center'>
							<a href='{{ route('evaluation.edit', [$evaluation]) }}' class='btn btn-sm btn-success'><i class='fa fa-edit'></i></a>
						</td>
					</tr>
				@endforeach
			</tbody>
