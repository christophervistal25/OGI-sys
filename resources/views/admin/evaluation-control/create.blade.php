...
<div class="card shadow mb-4 rounded-0">
	<div class="card-header py-3 rounded-0">
		<h6 class="m-0 font-weight-bold text-primary">Create Grade Evaluation Deadline Form</h6>
	</div>
	...
	<div class="card-body">
		<form method="POST" action="{{ route('evaluation.store') }}">
			...
			<input type="submit" value="Create Deadline" class='float-right btn btn-primary'>
		</form>
	</div>
</div>
